...
function mostrarMedallas() {
  ...
  const tbody = medallasTable.querySelector("tbody");
  ...
  medallasData.forEach(medalla => {
    ...
    image.className = "medal-image";
    image.src = getMedalImage(medalla.medalla);
    image.alt = medalla.medalla;
...
// Función para obtener la ruta de la imagen de la medalla
function getMedalImage(medalType) {
  switch (medalType) {
    case "Oro":
      return "./img/medalla_oro.jpg";
    case "Plata":
      return "./img/medalla_plata.jpg";
    case "Bronce":
      return "./img/medalla_bronce.jpg";
    default:
      return "";
  }
}
